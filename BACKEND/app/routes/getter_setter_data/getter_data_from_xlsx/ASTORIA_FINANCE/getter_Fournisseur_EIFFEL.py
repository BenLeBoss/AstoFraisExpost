import pandas as pd
from app.routes.getter_setter_data.setter_data_from_xlsx.setter_Fournisseurs_data import setter_data_fournisseur_eiffel



def getter_data_fournisseur_Eiffel(Fournisseur_doc):
    ...
    for index, row in Fournisseur_doc.iterrows():
        ...
        if pd.notna(row["00030_Financial_Instrument_Name"]):
            ...
            # Les taux Eiffel sont donnés sous forme décimal, il faut les multiplier par 100 pour les obtenir sous forme de pourcentage
            ...
            if t8030_Financial:
                ...
                setter_data_fournisseur_eiffel(IntituleProduit, TypeFrais1_percent, TypeFrais2_percent, TypeFrais3_percent, "M1")
